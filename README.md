...
Below is an animation<!--are two concerted animations--> that <!--show -->shows <!--(1) the trajectory of the tetramine **A** across the 811 conformers within 100 kcal mol<sup>-1</sup> of minimum energy, (2) -->an animated 3D plot showing the DFT energy of the 811 <!--these-->conformers.
